    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('REGISTRATION', 'New User Registration'), ('EMAIL_CHANGE', 'Email Address Change')], max_length=20)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'purpose'], name='users_email_user_id_d77b18_idx'), models.Index(fields=['expires_at'], name='users_email_expires_7cc044_idx')],
            },
        ),
    ]
